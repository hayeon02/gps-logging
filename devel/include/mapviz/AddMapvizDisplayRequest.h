...
struct AddMapvizDisplayRequest_
{
  ...
  _visible_type visible;
   ...
   typedef std::vector< ::marti_common_msgs::KeyValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::marti_common_msgs::KeyValue_<ContainerAllocator> >> _properties_type;
