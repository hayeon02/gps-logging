...
public:
    ...
    {
        image_config->setWindowTitle(QApplication::translate("image_config", "Form", nullptr));
        label->setText(QApplication::translate("image_config", "Topic:", nullptr));
        transport_combo_box->setItemText(0, QApplication::translate("image_config", "default", nullptr));

        label_3->setText(QApplication::translate("image_config", "Anchor:", nullptr));
        keep_ratio->setText(QApplication::translate("image_config", "Keep original aspect ratio", nullptr));
        label_8->setText(QApplication::translate("image_config", "Units:", nullptr));
        label_7->setText(QApplication::translate("image_config", "Height:", nullptr));
        units->setItemText(0, QApplication::translate("image_config", "pixels", nullptr));
        units->setItemText(1, QApplication::translate("image_config", "percent", nullptr));

        label_9->setText(QApplication::translate("image_config", "Transport:", nullptr));
        label_2->setText(QApplication::translate("image_config", "Status:", nullptr));
        label_6->setText(QApplication::translate("image_config", "Width:", nullptr));
        status->setText(QApplication::translate("image_config", "No topic", nullptr));
        label_5->setText(QApplication::translate("image_config", "Offset Y:", nullptr));
        label_4->setText(QApplication::translate("image_config", "Offset X:", nullptr));
        anchor->setItemText(0, QApplication::translate("image_config", "top left", nullptr));
        anchor->setItemText(1, QApplication::translate("image_config", "top center", nullptr));
        anchor->setItemText(2, QApplication::translate("image_config", "top right", nullptr));
        anchor->setItemText(3, QApplication::translate("image_config", "center left", nullptr));
        anchor->setItemText(4, QApplication::translate("image_config", "center", nullptr));
        anchor->setItemText(5, QApplication::translate("image_config", "center right", nullptr));
        anchor->setItemText(6, QApplication::translate("image_config", "bottom left", nullptr));
        anchor->setItemText(7, QApplication::translate("image_config", "bottom center", nullptr));
        anchor->setItemText(8, QApplication::translate("image_config", "bottom right", nullptr));

        selecttopic->setText(QApplication::translate("image_config", "Select", nullptr));
    } // retranslateUi
