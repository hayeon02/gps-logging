...
public:
    ...
    void setupUi(QWidget *odometry_config)
    {
        ...
        odometry_config->resize(287, 428);
        ...
        gridLayout->addWidget(positiontolerance, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(buffersize, 10, 1, 1, 1);
        ...
        gridLayout->addWidget(buttonResetBuffer, 10, 2, 1, 1);
        ...
        gridLayout->addWidget(show_timestamps, 11, 1, 1, 1);
        ...
        gridLayout->addWidget(show_all_covariances, 6, 1, 1, 1);

        label_12 = new QLabel(odometry_config);
        label_12->setObjectName(QString::fromUtf8("label_12"));
        label_12->setFont(font2);

        gridLayout->addWidget(label_12, 4, 0, 1, 1);

        use_latest_transforms = new QCheckBox(odometry_config);
        use_latest_transforms->setObjectName(QString::fromUtf8("use_latest_transforms"));

        gridLayout->addWidget(use_latest_transforms, 4, 1, 1, 1);
    ...
    {
        odometry_config->setWindowTitle(QApplication::translate("odometry_config", "Form", nullptr));
        label_3->setText(QApplication::translate("odometry_config", "Color:", nullptr));
        label_9->setText(QApplication::translate("odometry_config", "Static Arrow Sizes:", nullptr));
        label_10->setText(QApplication::translate("odometry_config", "Timestamp Interval:", nullptr));
        label->setText(QApplication::translate("odometry_config", "Topic:", nullptr));
        show_covariance->setText(QString());
        show_laps->setText(QString());
        positiontolerance->setSuffix(QString());
        status->setText(QApplication::translate("odometry_config", "No topic", nullptr));
        color->setText(QString());
        label_2->setText(QApplication::translate("odometry_config", "Status:", nullptr));
        selecttopic->setText(QApplication::translate("odometry_config", "Select", nullptr));
        label_6->setText(QApplication::translate("odometry_config", "Buffer Size:", nullptr));
        buttonResetBuffer->setText(QApplication::translate("odometry_config", "Clear", nullptr));
        label_5->setText(QApplication::translate("odometry_config", "Show Covariance:", nullptr));
        drawstyle->setItemText(0, QApplication::translate("odometry_config", "lines", nullptr));
        drawstyle->setItemText(1, QApplication::translate("odometry_config", "points", nullptr));
        drawstyle->setItemText(2, QApplication::translate("odometry_config", "arrows", nullptr));

        label_7->setText(QApplication::translate("odometry_config", "Draw Style:", nullptr));
        label_8->setText(QApplication::translate("odometry_config", "Show Laps", nullptr));
        label_4->setText(QApplication::translate("odometry_config", "Position Tolerance:", nullptr));
        show_timestamps->setSuffix(QString());
        static_arrow_sizes->setText(QString());
        label_11->setText(QApplication::translate("odometry_config", "All Covariances:", nullptr));
        show_all_covariances->setText(QString());
        label_12->setText(QApplication::translate("odometry_config", "Use Latest Transforms:", nullptr));
