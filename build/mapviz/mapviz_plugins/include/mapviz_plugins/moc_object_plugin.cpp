...
void mapviz_plugins::ObjectPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ObjectPlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::ObjectPlugin::staticMetaObject = { {
    &mapviz::MapvizPlugin::staticMetaObject,
    qt_meta_stringdata_mapviz_plugins__ObjectPlugin.data,
    qt_meta_data_mapviz_plugins__ObjectPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
