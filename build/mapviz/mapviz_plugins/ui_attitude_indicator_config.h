...
public:
    ...
    {
        attitude_indicator_config->setWindowTitle(QApplication::translate("attitude_indicator_config", "Form", nullptr));
        label_2->setText(QApplication::translate("attitude_indicator_config", "Status:", nullptr));
        status->setText(QApplication::translate("attitude_indicator_config", "No topic", nullptr));
        label_3->setText(QApplication::translate("attitude_indicator_config", "Topic:", nullptr));
        selecttopic->setText(QApplication::translate("attitude_indicator_config", "Select", nullptr));
    } // retranslateUi
