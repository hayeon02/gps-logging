...
public:
    ...
    {
        measuring_config->setWindowTitle(QApplication::translate("measuring_config", "Form", nullptr));
        label_3->setText(QApplication::translate("measuring_config", "Distance:", nullptr));
        measurement->setText(QString());
        label_5->setText(QApplication::translate("measuring_config", "Total Distance:", nullptr));
        totaldistance->setText(QString());
        main_color->setText(QString());
        label_2->setText(QApplication::translate("measuring_config", "Status:", nullptr));
        status->setText(QApplication::translate("measuring_config", "No topic", nullptr));
        show_measurements->setText(QString());
        label->setText(QApplication::translate("measuring_config", "Show Measurements:", nullptr));
        clear->setText(QApplication::translate("measuring_config", "Clear", nullptr));
        bkgnd_color->setText(QString());
        label_4->setText(QApplication::translate("measuring_config", "Main Color: ", nullptr));
        label_6->setText(QApplication::translate("measuring_config", "Background Color:", nullptr));
        label_7->setText(QApplication::translate("measuring_config", "Show Background Color:", nullptr));
        show_bkgnd_color->setText(QString());
        label_8->setText(QApplication::translate("measuring_config", "Font Size:", nullptr));
        label_9->setText(QApplication::translate("measuring_config", "Alpha:", nullptr));
    } // retranslateUi
