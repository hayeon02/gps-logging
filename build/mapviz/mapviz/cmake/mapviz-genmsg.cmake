...
set(MSG_I_FLAGS "-Imarti_common_msgs:/opt/ros/noetic/share/marti_common_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/yeon/SSC/src/mapviz/mapviz/srv/AddMapvizDisplay.srv" NAME_WE)
add_custom_target(_mapviz_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mapviz" "/home/yeon/SSC/src/mapviz/mapviz/srv/AddMapvizDisplay.srv" "marti_common_msgs/KeyValue"
)
...
_generate_srv_cpp(mapviz
  "/home/yeon/SSC/src/mapviz/mapviz/srv/AddMapvizDisplay.srv"
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/marti_common_msgs/cmake/../msg/KeyValue.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mapviz)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mapviz\")")
  # install generated code
  install(
